...
pub struct QuoteResponseDto {
    ...
    pub estimated_gas: i32,
}

impl QuoteResponseDto {
    pub fn new(from_token: crate::models::QuoteResponseDtoFromToken, to_token: crate::models::QuoteResponseDtoToToken, to_token_amount: String, from_token_amount: String, protocols: Vec<Vec<Vec<crate::models::PathViewDto>>>, estimated_gas: i32) -> QuoteResponseDto {
        QuoteResponseDto {
