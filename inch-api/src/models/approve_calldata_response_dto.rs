...
pub struct ApproveCalldataResponseDto {
...
impl ApproveCalldataResponseDto {
    pub fn new(data: String, gas_price: String, to: String, value: String) -> ApproveCalldataResponseDto {
