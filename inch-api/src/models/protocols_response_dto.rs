...
pub struct ProtocolsResponseDto {
    /// List of protocols that are available for routing in the 1inch Aggregation protocol
    #[serde(rename = "protocols")]
    pub protocols: Vec<crate::models::ProtocolImageDto>,
}

impl ProtocolsResponseDto {
    pub fn new(protocols: Vec<crate::models::ProtocolImageDto>) -> ProtocolsResponseDto {
