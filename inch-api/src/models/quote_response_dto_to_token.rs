...
/// QuoteResponseDtoToToken : Destination token info



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct QuoteResponseDtoToToken {
    #[serde(rename = "symbol")]
    pub symbol: String,
    #[serde(rename = "name")]
    pub name: String,
...
impl QuoteResponseDtoToToken {
    /// Destination token info
    pub fn new(symbol: String, name: String, address: String, decimals: f32, logo_uri: String) -> QuoteResponseDtoToToken {
        QuoteResponseDtoToToken {
            symbol,
            name,
            tags: None,
            address,
